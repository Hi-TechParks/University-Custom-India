	...
	public function index()
   	{
        ...
        for ($d = 1; $d <= $daysInMonth; $d++) {
            ...
            foreach ($programs as $program) {
                $daily_attendanceProgram[$program->title][$d] = $program->total_attendance;
            }
            ...
            foreach ($faculties as $faculty) {
                $daily_attendanceFaculty[$faculty->title][$d] = $faculty->total_attendance;
            }
        }

        $data['daily_attendanceProgram'] = $daily_attendanceProgram;
